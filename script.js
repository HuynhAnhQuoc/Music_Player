    ...
    songs: [
        {
            ...
            image: 'assets/img/emdongy-img.jpg',
        },
        {
            name: 'Waiting For You',
            singer: 'Mono x Onion',
            path: 'assets/music/WaitingForYou-MONOOnionn-7733882.mp3',
            image: 'assets/img/WaitingForYou-img.jpg',
        },
        {
            name: 'Nơi Tình Yêu Bắt Đầu',
            singer: 'Lam Anh, Bằng Kiều',
            path: 'assets/music/NoiTinhYeuBatDau-BuiAnhTuan-1915267.mp3',
            image: 'assets/img/noitinhyeubatdau.jpg',
        },
        {
            name: 'Cơn Mơ Băng Giá',
            singer: 'Bằng Kiều',
            path: 'assets/music/ConMoBangGia-BangKieu-4677122.mp3',
            image: 'assets/img/conmobanggia.jpg',
        },
        {
            name: 'See Tình',
